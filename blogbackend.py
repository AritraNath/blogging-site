...
app.config['MONGO_URI'] = "mongodb+srv://user:user@cluster0-azvt3.mongodb.net/test?retryWrites=true&w=majority"
mongo = PyMongo(app)

connection = MongoClient("mongodb+srv://user:user@cluster0-azvt3.mongodb.net/test?retryWrites=true&w=majority")
